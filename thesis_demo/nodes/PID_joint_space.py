...
#
# =====================================================================================================
# Name: PID_joint_space.py
# Author: Hélio Ochoa
# Version: 0.0
# Description: PID control in the joint space with/without gravity compensation
# =====================================================================================================
...
def main():
    rospy.init_node('PID_joint_space')
    ...
    # KST FILE
    # =================================================================================================
    path = '/home/ochoa/kst_thesis/PID_joint_space.txt'
    file = open(path, "w")
    ...
    while count < 100 * duration_sec:
        ...
        # Controller gains
        # =============================================================================================
        kp = np.matrix([[100], [108], [100], [22], [20], [20]])
        kd = np.matrix([[2], [6], [6], [0.6], [0.2], [0.2]])
        ki = np.matrix([[10], [10], [2], [5], [2], [0.5]])
        ...
        delta_velocity = np.subtract(dq_desired, dq_current)
        w = np.multiply(kp, delta_position) + np.multiply(ki, error_sum) + np.multiply(kd, delta_velocity)

        # Command Torques (tau)
        tau = w        # without gravity compensation
        # tau = w + g    # with gravity compensation
