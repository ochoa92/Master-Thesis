...
#
# =====================================================================================================
# Name: joint_space_v1.py
# Author: Hélio Ochoa
# Version: 1.0
# Description: Computed torque control in the joint space with inertia tensor in z -> 200 (Gazebo)
# =====================================================================================================
...
def main():
    ...
    # KST FILE
    # =================================================================================================
    path = '/home/ochoa/kst_thesis/joint_space_v1.txt'
    file = open(path, "w")
