...
#
# =====================================================================================================
# Name: joint_pos_control_robot.py
# Author: Hélio Ochoa
# Version: 0.0
# Description: Computed torque control in the joint space (JACO² 6DOF)
# =====================================================================================================
...
def main():
    ...
    # KST FILE
    # =================================================================================================
    path = '/home/ochoa/kst_thesis/joint_pos_control_robot.txt'
    file = open(path, "w")
    ...
    while count < 100*duration_sec:
        ...
        delta_velocity = np.subtract(dq_desired, dq)  # velocity error

        w = d2q_desired + kp*delta_position + ki*error_sum + kd*delta_velocity

        # Command Torques (tau)
        # tau = M*w + g
        tau = M*w   # with gravity(g) matrix of DSP
