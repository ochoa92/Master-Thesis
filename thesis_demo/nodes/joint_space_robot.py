...
#
# =====================================================================================================
# Name: joint_space_robot.py
# Author: Hélio Ochoa
# Version: 0.0
# Description: Computed torque control in the joint space (real Robot)
# =====================================================================================================
...
def main():
    rospy.init_node('joint_space_control_robot')
    ...
    # KST FILE
    # =================================================================================================
    path = '/home/ochoa/kst_thesis/joint_space_robot.txt'
    file = open(path, "w")
    ...
    while count < 100*duration_sec:
        ...
        # Controller Gains
        # =============================================================================================
        kp = np.matrix([[200], [180], [200], [22], [24], [20]])
        kd = np.matrix([[20], [34], [34], [6.4], [4], [2.6]])
        ki = np.matrix([[0.1], [0.3], [0.3], [0.3], [0.1], [0.1]])
